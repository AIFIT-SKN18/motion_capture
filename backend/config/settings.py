...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'aifit_db'),
        'USER': os.getenv('DB_USER', 'aifit'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'aifit1234'),
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(minutes=int(os.getenv('REFRESH_TOKEN_LIFETIME', 43200))),
